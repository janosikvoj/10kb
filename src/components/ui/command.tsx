      ...
      <DialogContent className="overflow-hidden p-0">
        <Command
          className={cn(
            ...
            '[&_[cmdk-group-heading]]:text-neutral'
          )}
        >
          {children}
        </Command>
...
>(({ className, ...props }, ref) => (
  <div
    className="flex items-center border-b border-neutral px-3"
    cmdk-input-wrapper=""
  >
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ...
    className={cn(
      ...
      'text-white [&_[cmdk-group-heading]]:text-neutral-lighter',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 h-px bg-neutral-lighter', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default gap-2 select-none items-center px-2 py-1.5 text-sm outline-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
      'data-[selected=true]:bg-neutral-lighter data-[selected=true]:text-white ',
      className
    )}
    {...props}
  />
